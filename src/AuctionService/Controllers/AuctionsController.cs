...
public class AuctionsController : ControllerBase
{
    ...
    {
        // Commented the basic flow, making changes for the synchronous communication
    ...
    public async Task<ActionResult<AuctionDto>> CreateAuction(CreateAuctionDto auctionDto)
    {
        ...
        return CreatedAtAction(nameof(GetAuction),
                new { auction.Id }, _mapper
                .Map<AuctionDto>(auction));
    }
    ...
    public async Task<ActionResult> UpdateAuction(Guid id, UpdateAuctionDto updateAuctionDto)
    {
        ...
        var result = await _context.SaveChangesAsync() > 0;
        if (result) return Ok();
        return BadRequest("Problem updating the aution");
